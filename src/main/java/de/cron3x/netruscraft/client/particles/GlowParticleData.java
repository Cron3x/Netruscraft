...
public class GlowParticleData implements ParticleProvider<ColorParticleTypeData> {
    ...
    public static ParticleOptions createData(ParticleColor color) {
        return new ColorParticleTypeData(ParticleRegister.GLOW_TYPE.get(), color, false);
    }

    public static ParticleOptions createData(ParticleColor color, boolean disableDepthTest) {
        return new ColorParticleTypeData(ParticleRegister.GLOW_TYPE.get(), color, disableDepthTest, 0.25f, 0.75f, 36);
    }
